        ...
        <main className="min-h-screen bg-white text-gray-900">
            ...
            <section className="border-b border-gray-100 px-10 md:px-20 py-16 bg-gray-50">
                <div className="max-w-4xl">
                    <p className="text-xs font-bold tracking-widest text-red-600 uppercase mb-3">Våra kort</p>
                    <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight mb-4">
                        Hitta rätt<br />kreditkort för dig
                    </h1>
                    <p className="text-gray-500 text-lg max-w-lg leading-relaxed">
                        Välj bland våra kort – från Standard till Platinum. Alla med konkurrenskraftiga villkor och ingen dold avgift.
                    </p>
                </div>
            </section>
            ...
            <section className="px-10 md:px-20 py-16">
                {active.length > 0 ? (
                    ...
                    <div className="bg-gray-50 p-12 rounded-2xl border text-center">
                        <p className="text-gray-400 italic">Just nu finns inga aktiva kortmallar att visa.</p>
                    </div>
                )}
            </section>
